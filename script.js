...
const DEFAULT_STEPS = [
  ...
  {id:6,title:'Dialogues / scripts',desc:'Scènes et dialogues',status:'done'},
  {id:7,title:'Éléments techniques',desc:'Mécaniques de jeu, assets',status:'done'},
  {id:8,title:'Finitions',desc:'Tests, corrections',status:'doing'}
];
